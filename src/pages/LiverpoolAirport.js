...
function LiverpoolAirport () {
    return (
        <>
            <div className="flex flex-col bg-[#e7e3f1] h-auto">
        <section className="flex flex-col ml-[15%] mr-[15%] pt-12 pb-12 text-left">
          <h1 className="text-[36px] font-semibold text-[#5b1ecd] mb-[10px]">Airport Transfers To Liverpool Aiport</h1>
          <p className="p-1">If you need a taxi to Liverpool Airport at a competitive rate look no further than Whitesides Taxis Blackpool. Whitesides Taxis Blackpool provides you with the smartest cars, the most reliable drivers at competitive rates. Thus ensuring you arrive relaxed and stress free.</p>
      ...
      <div className="flex flex-col h-auto pt-[3rem] pb-[3rem] bg-[#e7e3f1] ">
        ...
        <table className="ml-[15%]">
          ...
          <tbody>
            <tr>
              <td>BLACKPOOL TO LIVERPOOL AIRPORT</td>
              <td>85.00</td>
              <td>80.00</td>
            </tr>

            <tr>
              <td>LYTHAM ST ANNES TO LIVERPOOL AIRPORT</td>
              <td>85.00</td>
              <td>80.00</td>
            </tr>

            <tr>
              <td>POULTON TO LIVERPOOL AIRPORT</td>
              <td>85.00</td>
              <td>80.00</td>
            </tr>

            <tr>
              <td>THORNTON & CLEVELEYS TO LIVERPOOL AIRPORT</td>
              <td>85.00</td>
              <td>80.00</td>
            </tr>

            <tr>
              <td>WARTON & WREA GREEN TO LIVERPOOL AIRPORT</td>
              <td>85.00</td>
              <td>80.00</td>
            </tr>

            <tr>
              <td>FRECKLETON & KIRKHAM TO LIVERPOOL AIRPORT</td>
              <td>85.00</td>
              <td>80.00</td>
            </tr>

            <tr>
              <td>FLEETWOOD TO LIVERPOOL AIRPORT</td>
              <td>98.00</td>
              <td>93.00</td>
            </tr>
          </tbody>
        ...
        <div>
          ...
          <tbody>
            <tr>
              <td>LIVERPOOL AIRPORT TO BLACKPOOL</td>
              <td>90.00</td>
              <td>85.00</td>
            </tr>

            <tr>
              <td>LIVERPOOL AIRPORT TO LYTHAM ST ANNES</td>
              <td>90.00</td>
              <td>85.00</td>
            </tr>

            <tr>
              <td>LIVERPOOL AIRPORT TO POULTON</td>
              <td>90.00</td>
              <td>85.00</td>
            </tr>

            <tr>
              <td>LIVERPOOL AIRPORT TO THORNTON & CLEVELEYS</td>
              <td>90.00</td>
              <td>85.00</td>
            </tr>

            <tr>
              <td>LIVERPOOL AIRPORT TO WARTON & WREA GREEN</td>
              <td>90.00</td>
              <td>85.00</td>
            </tr>

            <tr>
              <td>LIVERPOOL AIRPORT TO FRECKLETON & KIRKHAM</td>
              <td>90.00</td>
              <td>85.00</td>
            </tr>

            <tr>
              <td>LIVERPOOL AIRPORT TO FLEETWOOD</td>
              <td>103.00</td>
              <td>98.00</td>
            </tr>
          </tbody>
      ...
      <div className="bg-white height-auto flex flex-col ml-[15%] pt-[3rem] pb-[3rem]">
        ...
        <a className="w-[fit-content] h-[fit-content] px-8 py-4 border-[2px] border-solid border-[#5b1ecd] rounded-[8px] text-[#5b1ecd] hover:bg-[#5b1ecd] hover:text-[white] hover:[transition:0.5s] " href="https://www.liverpoolairport.com/flights/arrivals-and-departures" target="blank">Check Here For Flight Information</a>
      </div>
      <SaveMoney />
      <CareerHero />
        </>
...
export default LiverpoolAirport;